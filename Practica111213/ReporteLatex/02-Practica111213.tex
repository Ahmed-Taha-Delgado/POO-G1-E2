...
En el caso de Dart, los hilos no se comunican entre sí directamente ya que no comparten memoria, éstos se comunican mediante \textbf{SendPort}  y \textbf{ReceivePort}, los cuáles enviarán y recibirán mensajes respectivamente.~\cite{Hilos}
...
\textbf{Algunos UML de los ejemplos:}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Imagenes/EstaticoEjemplo6.png}
...
\subsection{Diagramas de código de patrones de diseño}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Imagenes/EstaticoMVC.png}
    \caption*{Diagrama UML estático del código de patrón MVC}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Imagenes/Dinamico MVC.jpeg}
    \caption*{Diagrama UML dinámico del código de patrón MVC}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Imagenes/singleUMLClases.png}
    \caption*{Diagrama UML estático del código Singleton}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Imagenes/singelton secuencia.png}
    \caption*{Diagrama UML dinámico del código Singleton}
\end{figure}
